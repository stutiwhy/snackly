...
export default function Home() {
  ...
  const handlePlaceOrder = async () => {
    if (!hall || !seat || cart.length === 0) return;
    setIsOrdering(true);
  ...
  <div className="flex flex-col lg:flex-row gap-8 p-6 lg:p-12 min-h-screen bg-background">
    ...
    <div className="flex-1">
      <header className="mb-10">
        <h1 className="text-5xl font-black text-primary tracking-tighter italic">snackly</h1>
        <p className="text-muted-foreground mt-2">what would you like to have today?</p>
      </header>
